...
namespace ETradeBackend.Persistance.Migrations
{
    ...
    [Migration("20230613191135_mig_10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETradeBackend.Domain.Entities.CompletedOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETradeBackend.Domain.Entities.Endpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETradeBackend.Domain.Entities.File", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETradeBackend.Domain.Entities.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("ETradeBackend.Domain.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETradeBackend.Domain.Entities.InvoiceFile", b =>
                {
                    b.HasBaseType("ETradeBackend.Domain.Entities.File");
            ...
            modelBuilder.Entity("ETradeBackend.Domain.Entities.ProductImageFile", b =>
                {
                    b.HasBaseType("ETradeBackend.Domain.Entities.File");
            ...
            modelBuilder.Entity("AppRoleEndpoint", b =>
                {
                    b.HasOne("ETradeBackend.Domain.Entities.Endpoint", null)
                        .WithMany()
                        .HasForeignKey("EndpointsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ETradeBackend.Domain.Entities.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ETradeBackend.Domain.Entities.CompletedOrder", b =>
                {
                    b.HasOne("ETradeBackend.Domain.Entities.Order", "Order")
                        ...
                        .HasForeignKey("ETradeBackend.Domain.Entities.CompletedOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ETradeBackend.Domain.Entities.Endpoint", b =>
                {
                    b.HasOne("ETradeBackend.Domain.Entities.Menu", "Menu")
                        .WithMany("Endpoints")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ETradeBackend.Domain.Entities.Identity.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProductProductImageFile", b =>
                {
                    b.HasOne("ETradeBackend.Domain.Entities.ProductImageFile", null)
                        .WithMany()
